...
export class EntryExporter {
	...
	async exportEntry(entry: DashboardEntry, format: EntryExportFormat, options: ExportOptions): Promise<ExportResult> {
		try {
	...
	private async exportAsMarkdown(data: EntryExportData, options: ExportOptions): Promise<ExportResult> {
	...
	private async exportAsPlainText(data: EntryExportData, options: ExportOptions): Promise<ExportResult> {
	...
	private async exportAsPDF(data: EntryExportData, options: ExportOptions): Promise<ExportResult> {
	...
	private async exportAsImage(data: EntryExportData, options: ExportOptions): Promise<ExportResult> {
		// Convert markdown to HTML first
		const html = this.convertToHTML(data.fullContent, data.entry);
