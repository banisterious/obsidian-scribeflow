                    ...
                    .onClick(() => {
                            ...
                            subitem.setTitle('Markdown (.md)')
                                ...
                                .onClick(() => {
                                    selectedEntries.forEach(entry => 
                                        onExport(entry, EntryExportFormat.MARKDOWN)
                                    );
                                });
                        });
                        ...
                        submenu.addItem((subitem) => {
                            subitem.setTitle('Plain Text (.txt)')
                                ...
                                .onClick(() => {
                                    selectedEntries.forEach(entry => 
                                        onExport(entry, EntryExportFormat.PLAIN_TEXT)
                                    );
                                });
                        });
                        ...
                        submenu.addItem((subitem) => {
                            subitem.setTitle('PDF (.pdf)')
                                ...
                                .onClick(() => {
                                    selectedEntries.forEach(entry => 
                                        onExport(entry, EntryExportFormat.PDF)
                                    );
                                });
                        });
                        
                        submenu.addItem((subitem) => {
                            subitem.setTitle('Image (.png)')
                                .setIcon('image')
                                .onClick(() => {
                                    selectedEntries.forEach(entry => 
                                        onExport(entry, EntryExportFormat.IMAGE)
                                    );
                                });
                        });
